...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname a0q3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;; Assignment0 Question3
...
;; 1. True or False:
;;    Students do not need to check the course Web site for announcements
...
;; 3. How often should students check the course Web site for announcements?
;;    a) Never
;;    b) Once a week
...
;;    d) Check the course Web site for an announcement describing what
;;       to do and continue trying to submit on MarkUs.

;; ANSWER:


;; 5. According to the Style Guide, what is the correct filename for 
...
;; 6. You submitted your solutions on MarkUs and the public test email indicated
;;    that there was an error with your code. However, you do not understand
;;    the error message. What should you do?
;;    a) You can ignore the error message because public tests are not
;;       for marks.
